...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query_pengajuan = "SELECT p.id FROM pengajuan_akademik p JOIN Mahasiswa m ON m.id = p.id_mahasiswa WHERE m.nim = ?";
    ...
    $query_cek_konfirmasi = "SELECT id FROM konfirmasi_akademik WHERE id_pengajuan = ?";
    ...
    $query_update = "UPDATE konfirmasi_akademik SET status1 = ?, status2 = ?, komentar = ?, last_modified = ? WHERE id_pengajuan = ?";
    $params_update = [
